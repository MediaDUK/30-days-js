  ...
  render() {
    return (
      <section className="day">
        ...
        <div className="keys">
          <Key keyCode={65} keyLetter={"A"} name={"Guitar 1"} />
          <Key keyCode={83} keyLetter={"S"} name={"Guitar 2"} />
          <Key keyCode={68} keyLetter={"D"} name={"Guitar 3"} />
          <Key keyCode={70} keyLetter={"F"} name={"Guitar 4"} />
          <Key keyCode={71} keyLetter={"G"} name={"Kick"} />
          <Key keyCode={72} keyLetter={"H"} name={"Clap"} />
        </div>
      </section>
    );
  }
